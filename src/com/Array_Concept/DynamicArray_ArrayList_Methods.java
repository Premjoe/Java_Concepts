...
public class DynamicArray_ArrayList_Methods {
	...
	public static void main(String[] args) {
		...
		marksList.add(1);// 0(index)
		marksList.add(2);// 1(index)
		marksList.add(3);// 2(index)
		marksList.add(4);// 3(index)
		// value
		// Index also number and value also index, In this case bit confused to remove
		// the index so we can use this
		// We can remove the with 2 types : By Index method or By Value method
...
//		}
		...
		// JDK 1.9
		// Immutable List or fixed list -- > can not be changed now - no add/remove
		// List is interface (It's having method but it's not having method body)
		// Array List is child of List interface
...
//		System.out.println(nList.size());
		...
		monthsList.trimToSize(); // trim the VC to the current pc - Memory optimisation
		// vc=6,pc=6
		// vc=6/2=3
