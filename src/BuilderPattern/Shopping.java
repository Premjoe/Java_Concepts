...
//	public Shopping login(int l) {
//		System.out.println("user is logged in");
//		return new Shopping();  -- Its not a proper way because for single user passing the object wasting the memory (every time calling the method )
//	}
	
	public Shopping login() {
		System.out.println("user is logged in");
		return this; // This means - indicating current class object 
	}
